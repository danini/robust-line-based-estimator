...
// 22.09.2018: Viktor Larsson: Moved to single header
...
inline double evalpoly(int ord, double *coef, double x)
{
	double *fp = &coef[ord];
	double f = *fp;
...
inline int modrf_pos(int ord, double *coef, double a, double b,
...
inline int modrf(int ord, double *coef, double a, double b, double *val)
{
...
inline static int modp(poly *u, poly *v, poly *r)
{
...
inline int buildsturm(int ord, poly *sseq)
{
	sseq[0].ord = ord;
	sseq[1].ord = ord - 1;
...
inline int numchanges(int np, poly *sseq, double a)
{
	int changes = 0;
...
inline int numroots(int np, poly *sseq, int *atneg, int *atpos, bool non_neg)
{
	int atposinf = 0;
	int atneginf = 0;
...
inline int sbisect(int np, poly *sseq,
...
inline int find_real_roots_sturm(
