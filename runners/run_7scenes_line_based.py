...
BLUR_SIGMA = 0.2
SG_THR = 0.3
OUTPUT_DB_PATH = f"matches/7scenes_matches_{MATCHER}_{matcher_type}_{line_method}_{FILTER_THRESHOLD}_{SG_THR}_{BLUR_SIGMA}_.h5"
...
SOLVERSs = [
            ...
            [[False, False, False, True, True, True, True, True], 3.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[False, False, False, True, True, True, True, True], 3.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            [[False, False, False, True, True, True, True, True], 5.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[False, False, False, True, True, True, True, True], 5.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            ...
            [[False, False, True, True, True, True, True, True], 3.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[False, False, True, True, True, True, True, True], 3.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            [[False, False, True, True, True, True, True, True], 5.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[False, False, True, True, True, True, True, True], 5.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            ...
            [[False, True, True, True, True, True, True, True], 3.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[False, True, True, True, True, True, True, True], 3.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            [[False, True, True, True, True, True, True, True], 5.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[False, True, True, True, True, True, True, True], 5.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            ...
            [[True, True, True, True, True, True, True, True], 3.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[True, True, True, True, True, True, True, True], 3.0, 6.0, 0, 15, True, False, False, True, 0, 0.0],
            [[True, True, True, True, True, True, True, True], 5.0, 6.0, 0, 15, False, False, False, True, 0, 0.0],
            [[True, True, True, True, True, True, True, True], 5.0, 6.0, 0, 15, True, False, False, True, 0, 0.0]
        ]

###########################################
# Initialize the dataset
###########################################
dataset = SevenScenes(root_dir=os.path.expanduser("/media/hdd2tb/datasets/7scenes"),
...
for i, data in enumerate(dataloader):
    ...
    if len(processing_queue) >= BATCH_SIZE or i == len(dataloader) - 1:
        ...
        for SOLVER_FLAGS, TH_VP_ANGLE, TH_PIXEL, MAX_JUNCTIONS, ANGLE_THRESHOLD, USE_JOINT_VP_MATCHING, USE_ENDPOINTS, USE_JUNCTIONS, REFINE_VP, LS_REFINEMENT, LINE_INLIER_RATIO in SOLVERSs:
            ...
            with open('7scenes_results_after_iccv.csv', 'a') as file:
